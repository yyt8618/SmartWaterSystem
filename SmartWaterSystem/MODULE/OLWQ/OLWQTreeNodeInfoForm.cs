...
{
    public partial class OLWQTreeNodeInfoForm : DevExpress.XtraEditors.XtraForm
    {
        public static UniversalWayTypeEntity entity = null;
        public OLWQTreeNodeInfoForm(bool typeEnable, int selectedindex)
        {
            InitializeComponent();
        ...
        private void OLWQTreeNodeInfoForm_Load(object sender, EventArgs e)
        {
            if (cbType.Enabled)
                cbType.Focus();
            else
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            int findresult=bll.TypeExist(((UniversalCollectType)cbType.SelectedIndex),txtName.Text,TerType.OLWQTer);
            if (-1 == findresult)
            {
