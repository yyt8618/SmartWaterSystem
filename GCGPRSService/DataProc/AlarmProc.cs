...
namespace GCGPRSService
{
    public class AlarmProc
    {
        ...
        /// <returns></returns>
        public static Dictionary<int,string> GetAlarmName(byte TerminalType,byte FunCode,byte AlarmFlaglow, byte AlarmFlaghigh)
        {
            ...
            if (GlobalValue.Instance.lstAlarmType != null && GlobalValue.Instance.lstAlarmType.Count > 0)
            {
                ...
                try
                {
                    if ((AlarmFlaglow & 0x01) == 1)
                    {
                        ...
                        name = GlobalValue.Instance.lstAlarmType[alarmid];
        ...
        /// <param name="AlarmFlag"></param>
        /// <returns></returns>
        public static Dictionary<int, string> GetAlarmName(byte TerminalType, byte FunCode, byte AlarmFlag)
        {
            Dictionary<int, string> lstAlarmName = new Dictionary<int, string>();
            if (GlobalValue.Instance.lstAlarmType != null && GlobalValue.Instance.lstAlarmType.Count > 0)
            {
